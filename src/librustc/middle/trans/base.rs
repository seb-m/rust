...
impl<'a, 'tcx> StatRecorder<'a, 'tcx> {
    pub fn new(ccx: &'a CrateContext<'tcx>, name: String)
               -> StatRecorder<'a, 'tcx> {
...
pub fn new_fn_ctxt<'a, 'tcx>(ccx: &'a CrateContext<'tcx>,
                       llfndecl: ValueRef,
                       id: ast::NodeId,
                       has_env: bool,
                       output_type: ty::t,
...
pub fn crate_ctxt_to_encode_parms<'a, 'tcx>(cx: &'a CrateContext<'tcx>,
